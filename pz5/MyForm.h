...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->toolStrip1->Size = System::Drawing::Size(955, 33);
			...
			this->newToolStripButton->ToolTipText = L"Íîâèé";
			...
			this->openToolStripButton->ToolTipText = L"Â³äêğèòè";
			...
			this->saveToolStripButton->ToolTipText = L"Çáåğåãòè";
			...
			this->printToolStripButton->ToolTipText = L"Äğóê";
			...
			this->cutToolStripButton->ToolTipText = L"Âèğ³çàòè";
			...
			this->copyToolStripButton->ToolTipText = L"Êîï³şâàòè";
			...
			this->pasteToolStripButton->ToolTipText = L"Âñòàâèòè";
			...
			this->helpToolStripButton->ToolTipText = L"Äîâ³äêà";
			...
			this->toolStripButton1->ToolTipText = L"Âèğ³âíşâàííÿ çë³âà";
			...
			this->toolStripButton3->ToolTipText = L"Âèğ³âíşâàííÿ ñïğàâà";
			...
			this->richTextBox1->Size = System::Drawing::Size(955, 535);
			...
			this->contextMenuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->âèğ³çàòèToolStripMenuItem1,
					this->êîï³şâàòèToolStripMenuItem1, this->âñòàâèòèToolStripMenuItem1, this->øğèôòToolStripMenuItem1, this->âèä³ëèòèÂñåToolStripMenuItem
			});
			this->contextMenuStrip1->Name = L"contextMenuStrip1";
			this->contextMenuStrip1->Size = System::Drawing::Size(187, 164);
			// 
			// âèğ³çàòèToolStripMenuItem1
			// 
			this->âèğ³çàòèToolStripMenuItem1->Name = L"âèğ³çàòèToolStripMenuItem1";
			this->âèğ³çàòèToolStripMenuItem1->Size = System::Drawing::Size(186, 32);
			...
			this->êîï³şâàòèToolStripMenuItem1->Size = System::Drawing::Size(186, 32);
			...
			this->âñòàâèòèToolStripMenuItem1->Size = System::Drawing::Size(186, 32);
			...
			this->øğèôòToolStripMenuItem1->Size = System::Drawing::Size(186, 32);
			...
			this->âèä³ëèòèÂñåToolStripMenuItem->Size = System::Drawing::Size(186, 32);
			...
			this->statusStrip1->Location = System::Drawing::Point(0, 569);
			this->statusStrip1->Name = L"statusStrip1";
			this->statusStrip1->Size = System::Drawing::Size(955, 32);
			...
			this->menuStrip1->Size = System::Drawing::Size(955, 33);
			...
			this->ôàéëToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->ñòâîğèòèToolStripMenuItem,
					this->â³äêğèòèToolStripMenuItem, this->çáåğåãòèToolStripMenuItem
			});
			...
			this->ñòâîğèòèToolStripMenuItem->Size = System::Drawing::Size(191, 34);
			...
			this->â³äêğèòèToolStripMenuItem->Size = System::Drawing::Size(191, 34);
			...
			this->çáåğåãòèToolStripMenuItem->Size = System::Drawing::Size(191, 34);
			...
			this->ğÿäîêÑòàíóToolStripMenuItem->Size = System::Drawing::Size(280, 34);
			...
			this->êîï³şâàòèToolStripMenuItem->Size = System::Drawing::Size(270, 34);
			...
			this->âèğ³çàòèToolStripMenuItem->Size = System::Drawing::Size(270, 34);
			...
			this->âñòàâèòèToolStripMenuItem->Size = System::Drawing::Size(270, 34);
...
#pragma endregion
	private: System::Void copyToolStripButton_Click(System::Object^ sender, System::EventArgs^ e) {
		richTextBox1->Copy();
		toolStripStatusLabel1->Text = "Êîï³şâàòì";
	}
	...
	private: System::Void helpToolStripButton_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("Àâòîğ ö³º¿ ïğîãğàìè-Áğèöîâà ²ëîíà Áîãäàí³âíà. Ñòóäåíòêà Â³ííèöüêîãî äåğæàâíîãî ïåäàãîã³÷íîãî óí³âåğñèòåòó ³ìåí³ Ìèõàéëà Êîöşáèíñüêîãî çà ñïåö³àëüí³ñòş Ìàòåìàòèêà, ²íôîìàòèêà. 3 êóğñ.", "Ïğî àâòîğà", MessageBoxButtons::OK, MessageBoxIcon::Information);
		toolStripStatusLabel1->Text = "Äîâ³äêà";
	}
	private: System::Void toolStripButton1_Click(System::Object^ sender, System::EventArgs^ e) {
		richTextBox1->SelectionAlignment = HorizontalAlignment::Left;
		toolStripStatusLabel1->Text = "Âèğ³âíşâàííÿ çë³âà";
	}
	...
	private: System::Void toolStripButton3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		toolStripStatusLabel1->Text = "Âèğ³âíşâàííÿ ñïğàâà";
	}
